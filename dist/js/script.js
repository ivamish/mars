...
/* harmony import */ var imask__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! imask */ "./node_modules/imask/esm/index.js");
...
document.addEventListener("DOMContentLoaded", function () {
  var element = document.querySelectorAll('[data-date]');
  var maskOptions = {
    mask: Date
  };
  element.forEach(function (input) {
    (0,imask__WEBPACK_IMPORTED_MODULE_11__["default"])(input, maskOptions);
  });
  ...
  document.getElementById('inputPeople').addEventListener('change', function () {
    ...
    this.value = "".concat(count, " ").concat(lbl);
  });
  ...
  function parallax(e) {
    ...
    var _depth = "".concat(70 - (_mouseX - _w) * 0.02, "% 100%");

    var _depth2 = "".concat(70 - (_mouseX - _w) * 0.03, "% 100%");

    var x = "".concat(_depth, ", ").concat(_depth2);
